...
###API_DYNAMIC_VIEWS_CONTROLLER_HEADER###
 ...
 *
 * The read-only list resource of the ###sview### view, answered by the
...
class ###ApiName###Controller extends ApiController
{
	...
	{###API_DYNAMIC_VIEWS_CONTROLLER_GETMODEL###
	}

	/**
	 * Display the list of the ###sview### view.###API_DYNAMIC_VIEWS_CONTROLLER_EXPECTATIONS###
	 *
	...
	{###API_DYNAMIC_VIEWS_CONTROLLER_ALLOWVIEW###
	}
}
