 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Layout;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('layout', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.layout', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('layout');
