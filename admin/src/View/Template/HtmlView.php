 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Template;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('template', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.template', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('template');
