 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Joomla_module;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('joomla_module', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.joomla_module', $this->item->id);
				}
				if ($this->canDo->get('joomla_module.create'))
				{
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('joomla_module');
