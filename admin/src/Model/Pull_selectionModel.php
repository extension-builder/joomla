...
/**
 * Componentbuilder Pull_selection Item Model
 *
 * @since  1.6
 */
class Pull_selectionModel extends ItemModel
{
	/**
	 ...
	 * @since   1.6
	 */
	protected $_context = 'com_componentbuilder.pull_selection';
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/pull_selection.css'
 	];
	...
	protected function populateState()
	{
		...
		$this->setState('pull_selection.id', $id);
	...
	public function getItem($pk = null)
	{
		...
		if (!$this->user->authorise('pull_selection.access', 'com_componentbuilder'))
		{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('pull_selection.id');
