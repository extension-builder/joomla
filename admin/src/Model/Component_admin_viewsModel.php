 ...
 * @since  1.6
 */
class Component_admin_viewsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_admin_views.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_admin_views.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_admin_views', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_admin_views.delete', 'com_componentbuilder.component_admin_views.' . (int) $record->id);
	}
