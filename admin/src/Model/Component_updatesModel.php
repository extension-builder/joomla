 ...
 * @since  1.6
 */
class Component_updatesModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_updates.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_updates.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_updates', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_updates.delete', 'com_componentbuilder.component_updates.' . (int) $record->id);
	}
